...
# calculator()
# 9-----------------------------------------
# Створення словника з номіналами банкнот та відповідними іменами особистостей
# banknotes = {
#     1: "Володимир Великий",
#     2: "Ярослав Мудрий",
...
#
# # Виведення значення номіналу і імені особи або повідомлення про неіснуючий номінал
# if nominal in banknotes:
#     print(f"Номінал: {nominal} грн, Особистість: {banknotes[nominal]}")
# else:
#     print("Неправильне значення номіналу")
# 10-------------------------------------------
